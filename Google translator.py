...
#translate button
translate=Button(root,text="Translate",font="Roboto 15 bold italic",activebackground="white",cursor="hand2",bd=1,width=10,
                 bg="black",height=2,fg="white",command=translate_now)
